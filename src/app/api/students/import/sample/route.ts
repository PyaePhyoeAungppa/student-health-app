...
export async function GET(req: Request) {
    ...
    try {
        ...
        const headers = [
            "เลขประจำตัว", "รหัสบัตรประชาชน", "วันเกิด", "ชั้น", "ห้อง", "เลขที่", "คำนำ", "ชื่อ", "นามสกุล", 
        ...
        const row1 = [
            "STU001", "1100000000000", "2010/05/20", "ม.1", "1", "1", "ด.ญ.", "สมหญิง", "ใจดี",
            "B", "13", "45", "150", "20.0", "ปกติ",
            "ปกติ", "ปกติ", "ปกติ", "",
            "20/20", "ปกติ", "ปกติ", "ปกติ"
        ];
